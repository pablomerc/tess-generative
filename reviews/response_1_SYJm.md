...
Note: Fig. 7 is already a z_ins intervention: the SNR traversal (fixed noise x₀, instrument conditioning swept across SNR percentiles) and artifact removal (HSC+HSC conditioning never seen in training) are precisely "replace z_ins and watch instrument statistics change while the galaxy stays put." The rebuttal should frame Fig. 7 that way explicitly.
