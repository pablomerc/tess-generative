...
Usage:
  python predict_all_poolcond.py --suffix poolcond
  python predict_all_poolcond.py --suffix poolcond --skip-prepare
  python predict_all_poolcond.py --suffix poolcond --prepare-only
  python predict_all_poolcond.py --suffix poolcond --datasets mmu,neighbors
"""
...
DEFAULT_CHECKPOINT = (
    ...
    "galaxy-flow-matching-neighbours/oa4g7hf5/checkpoints/"
    "best-epoch=488-step=128000.ckpt"
)
