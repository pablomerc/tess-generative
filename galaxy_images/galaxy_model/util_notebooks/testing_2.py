...
class ConditionalFlowMatchingModule(pl.LightningModule):
    ...
    def encode_only(self, cond_image: torch.Tensor) -> torch.Tensor:
        """
        Encode the conditioning image into a embedding.
        """
        return self.encoder(cond_image)
...
if __name__ == "__main__":
    ...
    dummy_image_batch = torch.randn(8, 4, 78, 78)

    encoded_images = model.encode_only(dummy_image_batch)
