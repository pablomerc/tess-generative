...
notify "🚀 [job $SLURM_JOB_ID] anomaly-ours-367k starting (sources={0,1}, ~366,706 examples): encode → fit → visualize"

# ── Step 1: Encode ──────────────────────────────────────────────────────────
notify "🔢 [job $SLURM_JOB_ID] Step 1/3: encoding 366,706 examples (sources={0,1}) with our model..."
...
notify "✅ [job $SLURM_JOB_ID] Step 1/3 done: latents saved"
...
notify "🎉 [job $SLURM_JOB_ID] anomaly-ours-367k ALL DONE!"
