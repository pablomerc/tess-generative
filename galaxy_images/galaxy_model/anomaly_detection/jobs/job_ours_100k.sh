...
notify "🚀 [job $SLURM_JOB_ID] anomaly-ours-100k starting: encode → fit → visualize"

# ── Step 1: Encode ──────────────────────────────────────────────────────────
notify "🔢 [job $SLURM_JOB_ID] Step 1/3: encoding all ~100k MMU examples with our model..."
...
notify "🎉 [job $SLURM_JOB_ID] anomaly-ours-100k ALL DONE!"
