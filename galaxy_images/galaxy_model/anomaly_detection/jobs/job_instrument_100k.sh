...
notify "🚀 [job $SLURM_JOB_ID] anomaly-ins-100k starting: encode → fit → visualize"
mkdir -p "$FIGDIR"

# ── Step 1: Encode ───────────────────────────────────────────────────────────
notify "🔢 [job $SLURM_JOB_ID] Step 1/3: encoding all ~100k MMU examples with instrument encoder..."
...
notify "🎉 [job $SLURM_JOB_ID] anomaly-ins-100k ALL DONE!"
