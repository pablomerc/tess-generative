#!/bin/bash
#SBATCH -J anomaly-aion-100k-fit
...
notify "🔧 [job $SLURM_JOB_ID] anomaly-aion-100k fit+visualize only (using existing latents)"
...
notify "🎉 [job $SLURM_JOB_ID] anomaly-aion-100k fit+visualize ALL DONE!"
