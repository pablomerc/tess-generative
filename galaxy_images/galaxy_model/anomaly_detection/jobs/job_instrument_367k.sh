...
notify "🚀 [job $SLURM_JOB_ID] anomaly-ins-367k starting (sources={0,1}, ~366,706 examples): encode → fit → visualize"
mkdir -p "$FIGDIR"

# ── Step 1: Encode ───────────────────────────────────────────────────────────
notify "🔢 [job $SLURM_JOB_ID] Step 1/3: encoding 366,706 examples (sources={0,1}) with instrument encoder..."
...
notify "🎉 [job $SLURM_JOB_ID] anomaly-ins-367k ALL DONE!"
