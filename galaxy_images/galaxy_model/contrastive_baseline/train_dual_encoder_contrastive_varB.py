"""
Variant B: random in-batch same-survey as instrument positives, physics pair NOT explicit negative.
"""
...
RUN_NAME = "dual-encoder-contrastive-varB-random-pos"
...
def main():
    ...
    model = DualEncoderContrastiveModule(
        ...
        umap_n_neighbors=15,
        umap_min_dist=0.1,
        include_physics_pair_as_instrument_negative=False,
