"""
Run downstream prediction for neighbors-only objectives and create neighbors plot.
...
def run_task(task_name, h5_stem, default_use_embedding, target_list, h5_path, seed, use_gpu, key1, key2):
...
def main():
    p = argparse.ArgumentParser(description="Predict neighbors-only downstream objectives for contrastive baseline.")
