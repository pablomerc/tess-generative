...
LATENTS="${GALAXY_MODEL_DIR}/neighbor_search/neighbor_latents_2026-04-05_test1k.h5"
OUT_DIR="${GALAXY_MODEL_DIR}/neighbor_search_lenses/outputs_test1k"
...
notify "✅ [job ${SLURM_JOB_ID:-local}] Lens neighbor search done — figures in ${OUT_DIR}"
