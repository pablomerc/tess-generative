"""Combined data-driven noise model figure -- plain matplotlib (no SciencePlots).
...
Both intermediate npz files live next to this script, so the figure is fully
reproducible from this directory alone.

Outputs: datadriven_noise_model_figure_plain.{pdf,png}
"""
...
# --- Times New Roman / serif at a uniform larger size ---
plt.rcParams.update({
    "font.family": "serif",
...
def main():
    ...
    # SNR arrow under the reconstruction columns
    ...
    # Light vertical dividers between pair groups.
    ...
    out_pdf = HERE / "datadriven_noise_model_figure_plain.pdf"
    out_png = HERE / "datadriven_noise_model_figure_plain.png"
