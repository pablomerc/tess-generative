"""
make_figure_no_legacy_inst23.py — variant of make_figure_no_legacy.py showing
Instrument NN#2 and NN#3 instead of NN#1 and NN#2.

Usage:
    cd figures_for_paper/nearest_neighbors_figure
    python make_figure_no_legacy_inst23.py
"""
...
QUERY_CACHE = "query_172_inst23.npz"
...
def load_query():
    d = np.load(CACHE_DIR / QUERY_CACHE, allow_pickle=False)
...
if __name__ == "__main__":
    base = _here / "nearest_neighbors_figure_no_legacy_inst23"
